...
const SignUp = () => {
  ...
  return (
    <div
      className="flex items-center justify-center min-h-screen bg-cover bg-center mb-20 mt-28 ml-2 xl:mx-8 rounded bg-transparent opacity-70"
      style={{
        backgroundImage:
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <div>
              <button
                type="submit"
                className="w-full px-8 py-3 font-semibold rounded-md dark:bg-black text-white hover:bg-yellow-500 hover:text-black"
              >
                Sign Up
              </button>
            </div>
            <p className="px-6 text-sm text-center text-black">
              ...
              <a href="/form" className="hover:underline text-black">
                Log in
              </a>
              .
            </p>
